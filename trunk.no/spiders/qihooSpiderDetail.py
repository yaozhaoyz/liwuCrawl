...
detailURLs = "qihooresult/detailurl.txt";
tempOUT = open("qihooresult/out.detail",'w');
tempOUT2 = open("qihooresult/out.validOrNot",'w');
...
#tempOUT.write("\n"+line+"\t");
	...
	def parse(self, response):
		...
		try:
			...
			thisOUT = open("qihooresult/dt_"+t_baikeName,'w');
			print thisOUT 
			gameImages = "";
			for i in t_imgs:
				gameImages += i;
...
#tempOUT2.write("$$$"+test2_url);
			...
			return None 
		return Request(test2_url,meta={'url':"qihooresult/dt_"+t_baikeName},callback=self.parse_stores)
